...
$sql = "INSERT INTO objeto (nome, data_criacao, data_chegada, condicao, pais_origem, historia, foto) VALUES ('$nome', $data_cri, $data_che, '$condicao', '$pais_origem', '$historia' ,'$foto')";
